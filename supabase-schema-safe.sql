-- Schema para o projeto Quadra Futsal Manager (Versão segura para re-execução)
...
-- Triggers (só cria se não existir)
...
SELECT 
    'Quadra Society Principal', 
    'Quadra society de grama sintética com iluminação', 
    'society', 
    120.00, 
    14, 
    '06:00', 
    '23:00', 
    ARRAY['iluminacao', 'vestiarios', 'estacionamento', 'lanchonete']
WHERE NOT EXISTS (SELECT 1 FROM courts WHERE name = 'Quadra Society Principal');

INSERT INTO courts (name, description, type, price_per_hour, max_players, operating_hours_start, operating_hours_end, features)
SELECT 
    'Quadra de Futsal 1', 
    'Quadra coberta com piso profissional', 
    'futsal', 
    80.00, 
    10, 
    '08:00', 
    '22:00', 
    ARRAY['quadra_coberta', 'vestiarios', 'bebedouro']
WHERE NOT EXISTS (SELECT 1 FROM courts WHERE name = 'Quadra de Futsal 1');

INSERT INTO courts (name, description, type, price_per_hour, max_players, operating_hours_start, operating_hours_end, features)
SELECT 
    'Quadra de Futsal 2', 
    'Quadra aberta com iluminação LED', 
    'futsal', 
    60.00, 
    10, 
    '06:00', 
    '23:00', 
    ARRAY['iluminacao', 'vestiarios']
WHERE NOT EXISTS (SELECT 1 FROM courts WHERE name = 'Quadra de Futsal 2');

-- Criar usuário admin inicial (senha: admin123) - só se não existir
INSERT INTO users (name, email, password, phone, role)
SELECT 
    'Administrador', 
    'admin@quadra.com', 
    '$2a$10$rOzJqQZQZQZQZQZQZQZZOzJqQZQZQZQZQZQZQZOzJqQZQZQZQ', 
    '(11) 99999-9999', 
    'admin'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@quadra.com');
